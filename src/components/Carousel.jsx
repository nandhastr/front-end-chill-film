...
const Carousel = ({ title, items, settings }) => {
    ...
    return (
        <section className="mb-4">
            <div className="px-12 flex flex-col sm:gap-6">
                    ...
                    <Slider {...settings}>
                        {items.map((item, index) => (
                            <div key={index} className="carousel-item relative">
                                ...
                                <img src={item.url} alt={item.title} className="slide-image w-full px-3 object-cover rounded-lg hover:scale-[1.1] transition duration-500" onClick={() => handleItemClick(item)} />
